...
void CopyPrimeNumbers(int arrSource[], int arrDestination[], int arrLength, int &arrLength2)
{
    for (int i = 0; i < arrLength; i++)
...
{
    cout << "\n\n-------------------------------------------------------------------------------------------------\n\n";
    cout << "Problem #39 : Write a program to fill array with max size 100 with random numbers from 1 to 100, copy only prime numbers to another array using AddArrayElement, and print it.\n ";
    cout << "\tex  : Enter how many randmon number to be created in array : 5\n\t=>\tArray 1 elements : 41 30 88 94 4\n\t\tArray 2 elements after copy Prime numbers : 41\n\n";
    ...
    cout << "[ Array 2 elements after  copy Prime numbers] ";
