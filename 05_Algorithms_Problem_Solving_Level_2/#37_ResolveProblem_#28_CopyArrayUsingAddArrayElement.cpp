...
void CopyArrayUsingAddArrayElement(int arrSource[], int arrDestination[], int arrLength, int &arrLength2)
{
    for (int i = 0; i < arrLength; i++)
...
{
    cout << "\n\n-------------------------------------------------------------------------------------------------\n\n";
    cout << "Problem #37 : Write a program to fill array with max size 100 with random numbers from 1 to 100, copy it to another array using AddArrayElement, and print it.\n ";
